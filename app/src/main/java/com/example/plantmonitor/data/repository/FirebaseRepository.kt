package com.example.plantmonitor.data.repository

import android.util.Log
import com.example.plantmonitor.data.FirebasePaths
...
class FirebaseRepository(
    ...
    suspend fun claimDevice(uid: String, plantId: String, deviceId: String, claimCode: String): Result<Unit> {
        ...
        return try {
            ...
            if (!success) {
                android.util.Log.e("PlantIQ", "Handshake timeout - metadata never appeared or mismatched")
